...
public class AuthInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(
		...
		// 요청 주소
		String  requestURI  = request.getRequestURI();    // /Board/list, /BoardPaging/List 둘중 하나가된다
		String  qryStr      = request.getQueryString();   // menu_id=MENU01, menu_id=MENU01&nowpage=1
		String  loc         = requestURI + "?" + qryStr;  // /BoardPaging/List?menu_id=MENU01&nowpage=1 -> 이렇게 표시가 된다
